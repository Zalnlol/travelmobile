...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('travelmobile-css/travelmobile.css') }}">
    <!--custom project css-->
    <!-- Template 2095 Level -->
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyDi2UpnA_1qXGCGZmnqx-UegSOGAmIspD8">
    </script>
                ...
                <div class="row">
                    ...
                    <nav class="navbar navbar-expand-lg narbar-light">
                        <div class="logo-team">
                            <a href="{{ url('/') }}">
                                <div>
                                    <img src="{{ asset('images/travel-mobile-logo.png') }}" style="width: 100%"
                                        alt="Site logo">
                                </div>
                            </a>
                        </div>
