    ...
    <ul class="form-section page-section">
      ...
      <form action="{{ route('rental.store') }}" method="post">
        ...
        <li class="form-line form-line-column form-col-6" data-type="control_dropdown" id="id_10">
          <label class="form-label form-label-top" id="hangxe" for="brand" onchange="return chiecxe()"> Hãng xe </label>
          <div id="cid_10" class="form-input-wide">
            <select class="form-dropdown" id="input_10" name="brand" style="width:150px" data-component="dropdown">
        ...
        <li class="form-line form-line-column form-col-6" data-type="control_dropdown" id="id_10">
          <label class="form-label form-label-top" id="chiecxe" for="name"> Mẫu xe </label>
          <div id="cid_10" class="form-input-wide">
            <select class="form-dropdown" id="input_10" name="name" style="width:150px" data-component="dropdown">
